...
const ssSwiper = function() {
    ...
    // Gallery Swiper - CORRIGEZ CE CODE
    const gallerySwiper = new Swiper('.gallery-slider', {
        slidesPerView: 1, /* 1 seule image visible à la fois */
        spaceBetween: 30,
        loop: true,
        ...
        breakpoints: {
            640: {
                slidesPerView: 1, /* Toujours 1 seule image sur tablette */
                spaceBetween: 40,
            },
            1024: {
                slidesPerView: 1, /* Toujours 1 seule image sur desktop */
                spaceBetween: 50,
            }
        }
    });
